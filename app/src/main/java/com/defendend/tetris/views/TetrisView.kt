package com.defendend.tetris.views
...
class TetrisView : View {
    ...
    private fun drawCell(canvas: Canvas, x: Int, y: Int, rgbColor: Int) {
        ...
        val bottom: Float =
            (frameOffset.height + (y + ONE) * cellSize.height - BLOCK_OFFSET).toFloat()

        val right: Float = (frameOffset.width + (x + ONE) * cellSize.width - BLOCK_OFFSET).toFloat()
